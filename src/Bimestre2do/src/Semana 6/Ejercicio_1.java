...
/**
 * Programa para Consultar,Retirar,Depositar en un Cajero Automatico
 */
public class Ejercicio_1 {
    ...
    /**
     * Aqui se se hacer la operacion Cajero Automatico
     */
    ...
    public static void main(String[] args) {
        Ejercicio_1 abc = new Ejercicio_1();
        abc.ejecutar();
    }
}